...
- Booking flow with multi-day event booking, per-day pricing, booking-day selection, student discount, advance-booking discount tiers, payment details, and PDF receipt
